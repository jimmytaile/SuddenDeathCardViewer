...
const cardList = new Array(
  // Abilities
  ["agony_manifest", "Agony Manifest", "Ability", "Masochist"],
  ["bomber_games", "Bomber Games", "Ability", "Moneybags"],
  ["calling_card", "Calling Card", "Ability", "Aoi Manto"],
  ["danse_macabre", "Danse Macabre", "Ability", "Hitzel"],
  ["dark_white", "Dark White", "Ability", "Riley"],
  ...
  ["geisterherz", "Geisterherz", "Ability", "Umbra"],
  ...
  ["jabberwocky", "Jabberwocky", "Ability", "Knell"],
  ["lets_go_gambling", "Let's Go Gambling!", "Ability", "Albert"],
  ...
  ["natural_boy_genius", "Natural Boy Genius", "Ability", "Pinky"],
  ["occult_cutlery", "Occult Cutlery", "Ability", "Jujube"],
  ...
  ["trusty_magnifying_glass", "Trusty Magnifying Glass", "Ability", "Detective Dark"],
  ...
  ["scovillain_evolution", "Scovillain Evolution", "Event", "Pepper"],
  ...
  ["stress", "Stress", "Event", ""],
  ["temporal_anguish", "Temporal Anguish", "Event", ""],
  ...
  ["yob_yob", "Yob Yob", "Event", ""],
  ["zero_degree_murder", "Zero-Degree Murder", "Event", ""],
  // Items
  ["asternsolid_shell", "Asternsolid Shell", "Item", ""],
  ["backup_milk_carton", "Backup Milk Carton", "Item", "Food"],
  ["banchou_bodysuit", "Banchou Bodysuit", "Item", ""],
  ["blood_wine", "Blood Wine", "Item", "Food"],
  ["capsaicin_core", "Capsaicin Core", "Item", ""],
  ["chatty", "Chatty", "Item", "Occult"],
  ["clown_cola", "Clown Cola", "Item", "Food"],
  ["detached_hand", "Detached Hand", "Item", ""],
  ["eidolon_elixir", "Eidolon Elixir", "Item", "Occult Food"],
  ["flesh_fungus", "Flesh Fungus", "Item", "Occult Food"],
  ["follower_mask", "Follower Mask", "Item", "Occult Mask"],
  ["fortune_cookie", "Fortune Cookie", "Event", "Food"],
  ["freshly_squeezed_lemonade", "Freshly Squeezed Lemonade", "Item", "Food"],
  ["nibble_bar", "Nibble Bar", "Item", "Food"],
  ["observers_eye", "Observer's Eye", "Item", "Occult"],
  ...
  ["pocket_encyclopedia", "Pocket Encyclopedia", "Item", "Paper"],
  ["potion_of_self_love", "Potion of Self-Love", "Item", "Food"],
  ["psychologic_mask", "Psychologic Mask", "Item", "Mask"],
  ["purple_pebble", "Purple Pebble", "Item", ""],
  ["remote_control", "Remote Control", "Item", ""],
  ["sniffer_mask", "Sniffer Mask", "Item", "Mask"],
  ["strange_totem", "Strange Totem", "Item", "Occult"],
  ...
  ["b_b_s_help", "B.B.'s Help'", "Event", ""],
  ["both_kinda_pain", "Both Kinda Pain", "Event", ""],
  ["chartreuse_paper", "Chartreuse Paper", "Item", "Paper"],
  ["chocolate", "Chocolate!!!", "Event", ""],
  ["cyan_paper", "Cyan Paper", "Item", "Paper"],
  ...
  ["green_paper", "Green Paper", "Event", "Paper"],
  ["hangover", "Hangover", "Ability", ""],
  ["hot_pobombo", "Hot Pobombo", "Event", ""],
  ["indigo_paper", "Indigo Paper", "Event", "Paper"],
  ["lacerated", "Lacerated", "Event", ""],
  ["mandible_knife", "Mandible Knife", "Event", ""],
  ["masochist_armor", "Masochist Armor", "Item", ""],
  ["miedos_help", "Miedo's Help", "Event", ""],
  ["ms_favorite", "M's Favorite", "Event", ""],
  ["no_thank_you", "No Thank You", "Event", ""],
  ["one_lemonade_please", "One Lemonade Please!", "Event", ""],
  ["orange_paper", "Orange Paper", "Event", "Paper"],
  ["physical_pain", "Physical Pain", "Event", ""],
  ["pinkys_help", "Pinky's Help", "Event", ""],
  ["purple_chopsticks", "Purple Chopsticks", "Event", ""],
  ["purple_pain", "Purple Pain", "Event", ""],
  ["purple_paper", "Purple Paper", "Event", "Paper"],
  ["purple_stuff", "Purple Stuff", "Event", ""],
  ["purpled", "Purpled", "Event", ""],
  ["purplefication", "Purplefication", "Event", ""],
  ["secret_message", "Secret Message", "Event", ""],
  ["strangled", "Strangled", "Event", ""],
  ["swine_fork", "Swine Fork", "Event", ""],
  ["ultrablue_paper", "Ultrablue Paper", "Item", "Paper"],
